...
\Sexpr{length(results.intel$fft$octave[1,])} razy co
...
<<sin.intel, fig.cap="splot">>=

preparePlot(results.intel$sin)

@ 

<<sin.amd, fig.cap="splot">>=
...
<<fft.intel, fig.cap="splot">>=

preparePlot(results.intel$fft)

@ 

<<fft.amd, fig.cap="splot">>=
...
<<four1.intel, fig.cap="splot">>=

preparePlot(results.intel$four1)

@ 

<<four1.amd, fig.cap="splot">>=
...
<<conv.intel, fig.cap="splot">>=

preparePlot(results.intel$conv)

@ 

<<conv.amd, fig.cap="splot">>=
...
<<wavread.intel, fig.cap="splot">>=

preparePlot(results.intel$wavread)

@ 

<<wavread.amd, fig.cap="splot">>=
...
<<summary.intel, fig.cap="splot">>=

summaryPlot(results.intel)

@ 

<<summary.amd, fig.cap="splot">>=
