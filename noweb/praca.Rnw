...
\usepackage{listings}% Do zamieszczania kodu
\usepackage{color}
...
\label{cha:pakiety}
Zbadano pięć pekietów, które wybrano szczególnie ze względu na podobieństwo do MATLABa[odnośnik do alternativeto], oraz popularność[TIOBE].  
