...
wykorzystującego \emph{FLTK} (\emph{Fast Light Toolkit}), lecz istnieje
...
reprezentacja liczbowa (maksymalna liczba w FLTK nie może przekroczyć
...
szczegółowych wykresach trójwymiarowych). Interfejs FLTK jest
