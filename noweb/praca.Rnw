...
\@ifclassloaded{aghdpl}{
  ...
  \summaryPL{\indent\indent%
    ...
    pozostałymi, w każdym teście było inaczej, lecz średnio naszybsze
    okazały się: Anaconda, MATLAB i Julia. Biorąc całość badań pod uwagę
    wywnioskowano, że najlepszą alternatywą pod względem funkcjonalności
    i~prędkości jest Anaconda, mimo języka niepodobnego do MATLABa.
  }
