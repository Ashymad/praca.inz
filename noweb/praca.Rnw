...
funkcję \lstinline{sin()} na tych danych (Rys. \ref{tab:sintest}.
...
były najlepsze -- \emph{fftpack.fft} z biblioteki \emph{SciPy}.
\begin{table}[h]%
...
\Sexpr{length(results.list$fft$octave[1,])} razy co
